...
mh1 = mahasiswa("IqbalCJR", 37, "Solo", 100000)
mh2 = mahasiswa("Dayat", 38, "Polokarto", 110000)
mh3 = mahasiswa("Fian", 39, "Bekonang", 120000)
mh4 = mahasiswa("Ray", 150, "Magetan", 150000)
mh5 = mahasiswa("Puji", 210, "Sarangan", 220000)
